...
/// @title PolicyDomainRegistry
/// @notice A concrete policy-domain registry. Per-domain admin registers the
///         domain, rotates the root/program, and can revoke. Local-testing
...
contract PolicyDomainRegistry is IPolicyDomainRegistry {
    ...
    mapping(bytes32 => RootEntry) private _previous;
