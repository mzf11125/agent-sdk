...
pub fn compute_raw_input_hash(raw_user_input: &[u8]) -> B256 {
    keccak256(raw_user_input)
}

/// ERC-8299 §46: sanitization_pipeline_hash = keccak256(utf8(cid) || raw_input_hash)
pub fn compute_sanitization_pipeline_hash(cid: &str, raw_input_hash: B256) -> B256 {
...
mod tests {
    ...
    fn golden_raw_input_hash() {
        ...
        let expected = B256::from(hex!("1c8aff950685c2ed4bc3174f3472287b56d9517b9c948127319a09a7a36deac8"));
    ...
    fn golden_sanitization_pipeline_hash() {
        let raw_hash = B256::from(hex!("1c8aff950685c2ed4bc3174f3472287b56d9517b9c948127319a09a7a36deac8"));
        let cid = "ipfs://QmccvoM6aRVgZ2dtFWvT6Wm3DmTvoAUHHotK7uQufnStVR";
        let hash = compute_sanitization_pipeline_hash(cid, raw_hash);
        let expected = B256::from(hex!("5798efed4aa92f96a0622fc30268042b067294bdb5fd06f599bf8d84fd5d734b"));
        assert_eq!(hash, expected);
    }
    ...
    fn empty_input_produces_keccak_of_empty() {
        ...
        let expected = B256::from(hex!("c5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470"));
        assert_eq!(hash, expected);
    }
